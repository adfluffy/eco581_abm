...
to market
  ...
  set max_happiness_log fput max [happiness] of turtles max_happiness_log
  set min_happiness_log fput min [happiness] of turtles min_happiness_log
  ...
  (ifelse trades_executed > 0 [
    set happiness_per_trade delta_agg_happiness / trades_executed
   ]
   [
    set happiness_per_trade 0
   ]
   )
  set happiness_per_trade_log fput happiness_per_trade happiness_per_trade_log
...
to set-happiness
  ...
  (ifelse length happiness_log > 1 [
    set delta_happiness item 0 happiness_log - item 1 happiness_log
    ]
    [
...
to do-plots
  ...
  set-current-plot "Average Utility Change per Trade"
  plot happiness_per_trade
  set-plot-x-range 0 ticks
  set-plot-y-range (precision (0.9 * min happiness_per_trade_log) 2) max (list (precision (1.1 * max happiness_per_trade_log) 2) 0.1)
...
1019
911
Average Utility Change per Trade
NIL
NIL
0.0
10.0
